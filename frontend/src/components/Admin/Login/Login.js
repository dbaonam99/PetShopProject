...
export default function Login(props) {
    ...
    return (
        <div className="admin-login flex-center">
            ...
            <div className="admin-login-box flex-col">
                <div className="admin-login-logo flex-center">
                    <svg xmlns="http://www.w3.org/2000/svg" width="150" viewBox="0 34 300 84" fill="#007fc8">
