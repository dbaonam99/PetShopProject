            ...
            <Slider {...settings}>
                <div className="feedback-box flex">
                    <div className="feedback-image">
                        <img src="http://pe.heromc.net:4000/images/56233f629eb6e4f72c70dee4b0c22fc9" alt=""></img>
                    </div>
                ...
                <div className="feedback-box flex">
                    <div className="feedback-image">
                        <img src="http://pe.heromc.net:4000/images/335e9fdeb8bdb196e7d49e782c76a9a3" alt=""></img>
                    </div>
                    <div className="feedback-text flex-col">
                ...
                <div className="feedback-box flex">
                    <div className="feedback-image">
                        <img src="http://pe.heromc.net:4000/images/65ad65a723d5aa1cda611d64419d23b8" alt=""></img>
                    </div>
                    <div className="feedback-text flex-col"> 
