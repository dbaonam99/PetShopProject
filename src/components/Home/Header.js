                ...
                >
                    ...
                    >
                        <div className="navbar-item-sub-title">
                            <Link to="/dog" className="a">GPS cho chó</Link>
                            <div 
                                style={{width: `${window.innerWidth}px`}}
                                className="navbar-item-sub-box flex">
                                <div className="navbar-item-sub-box-text">
                                    <h5>GPS cho chó</h5>
                                    <p>Biết được chú chó bạn ở đâu vào bất cứ lúc nào với Tractive GPS được cài đặt ở trên điện thoại của bạn hoặc website.</p>
                                    <h4>Giá chỉ có: 1 000 000 đ</h4>
                                    <div className="flex"> 
                                        <div className="navbar-item-sub-box-btn">
                                            Mua Ngay
                                        </div>
                                ...
                                <img src="http://pe.heromc.net:4000/images/22fffa7a87dc926045e45bec7fb0778a" alt="" className="float-img"></img>
                        ...
                        <div className="navbar-item-sub-title">
                            <Link to="/cat" className="a">GPS cho mèo</Link>
                            <div 
                                style={{width: `${window.innerWidth}px`}}
                                className="navbar-item-sub-box flex">
                                <div className="navbar-item-sub-box-text">
                                    <h5>GPS cho mèo</h5>
                                    <p>Biết được chú mèo bạn ở đâu vào bất cứ lúc nào với Tractive GPS được cài đặt ở trên điện thoại của bạn hoặc website.</p>
                                    <h4>Giá chỉ có: 1 000 000 đ</h4>
                                    <div className="flex"> 
                                        <div className="navbar-item-sub-box-btn">
                                            Mua Ngay
                                ...
                                <img src="http://pe.heromc.net:4000/images/713ad131ac48116e48449bd7de087f8e" alt="" className="float-img"></img>
                                <div className="navbar-item-sub-box-img">
                                    <img src={cat} alt=""></img>
                                </div>
                            </div>
